...
import { ErrorBoundary, WelcomeModal } from "@/components/ui";
      ...
      >
        <div className="before:fixed before:inset-x-0 before:top-0 before:h-80 before:bg-gradient-to-b before:from-black/50 before:to-transparent before:z-[-1]">
          ...
          <div className="container mx-auto px-4 sm:px-0">
            ...
            <div className="text-center text-foreground/60 my-6">
              Powered by <b>Abdulrehman</b> 
              ∙ <b>Sci-Fi Dashboard</b> {" "}
              <a
                href="https://github.com/code-abdulrehman/sci-fi-dashboard"
                target="_blank"
